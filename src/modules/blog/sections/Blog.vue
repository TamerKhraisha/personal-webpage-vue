<template>
  <div
    ...
    class="popular-articles d-flex flex-column"
  >
    <v-row no-gutters align="center" justify="center" class="mt-10">
      <v-col cols="9">
        <div class="d-flex flex-column justify-center align-center white--text">
          <span
            :class="[$vuetify.breakpoint.lgAndDown ? 'display-1' : 'display-2']"
            style="font-family: Francois One !important"
          >
            TAMER KHRAISHA
          </span>
          <span
            :class="[$vuetify.breakpoint.lgAndDown ? 'headline' : 'display-1']"
          >
        ...
        <div class="mini-card-grid mb-n10">
          <article
...
.mini-card {
  ...
  background-image: linear-gradient(to right, #fad02c, #b18f09);
  box-shadow: -1rem 0 2rem #cbaf10;
  display: -webkit-box;
  display: flex;
  -webkit-box-orient: vertical;
  -webkit-box-direction: normal;
