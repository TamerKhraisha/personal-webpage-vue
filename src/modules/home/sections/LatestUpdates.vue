<template>
  <section id="blog" class="grey lighten-5">
    <div class="py-12"></div>
    ...
    <v-container>
      ...
      <v-row>
        <v-col v-for="(item, i) in articles" :key="i" cols="12" md="4">
          <v-img
            :src="item.src"
            class="mb-4"
            height="275"
          ...
          <p
            ...
            class="caption text-uppercase red--text"
          >
            {{ item.category }}
          </p>
          ...
          <div class="title font-weight-light mb-5 mt-2">
